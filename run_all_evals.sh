...
FSL_MAA_NET_CKPT="/content/drive/MyDrive/DIAS_Project/saved_models/MAA_Net/MAA_Net_NN_260525_182652"
...
python full_supervised_segmentation/fsl_test.py -mp "$FSL_MAA_NET_CKPT" --opts AMP False
python full_supervised_segmentation/fsl_test.py -mp "$FSL_FR_UNET_CKPT"
python full_supervised_segmentation/fsl_test.py -mp "$FSL_IPN_CKPT"
python full_supervised_segmentation/fsl_test.py -mp "$FSL_ST_UNET_CKPT"
