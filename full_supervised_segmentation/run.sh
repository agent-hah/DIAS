...
# python full_supervised_segmentation/fsl_train.py -mt UNet_Nested --tag NN -wm offline --opts SAVE_DIR "/content/drive/MyDrive/DIAS_Project/saved_models/UNet_Nested"
