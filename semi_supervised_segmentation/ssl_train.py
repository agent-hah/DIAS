...
from data import (
    build_train_single_loader,
    build_train_all_loader,
    build_val_loader,
...
def parse_option():
    ...
    parser.add_argument(
        "-nl", "--num_label", help="number of label data: (1-60)", type=int, default=1
    )
    parser.add_argument(
        "-nu",
        "--num_unlabel",
        help="number of unlabel data: (1-60)",
        type=int,
        default=30,
    )
    ...
    parser.add_argument(
        "--SDA",
        help="enable strong data augmentation for labeled training data",
        required=False,
        action="store_true",
    )
